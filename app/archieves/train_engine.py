...
COL_MAP = {"A":0,"B":1,"C":2,"D":3,"E":4,"F":5,"G":6,"H":7,"I":8}  # ICCS列映射
...
FEN_PIECE = {
    "K":RED_K,"R":RED_R,"N":RED_N,"C":RED_C,"E":RED_E,"A":RED_A,"P":RED_P,
    "k":BLK_K,"r":BLK_R,"n":BLK_N,"c":BLK_C,"e":BLK_E,"a":BLK_A,"p":BLK_P
}
...
class HybridXiangqiModel(nn.Module):
    def __init__(self, d_model=64, nhead=2, num_layers=2):
        ...
        layer = nn.TransformerEncoderLayer(d_model=d_model,nhead=nhead,dim_feedforward=128,batch_first=False)
