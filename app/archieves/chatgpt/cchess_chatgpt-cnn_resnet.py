...
TOTAL_IN_CHANNELS = BOARD_CHANNELS + HISTORY_LEN * STEP_CHANNELS + SIDE_CHANNELS
OUT_CHANNELS = 192
NUM_BLOCKS = 8
BATCH_SIZE = 256
...
class AlphaZeroXiangqi(nn.Module):
...
if __name__ == "__main__":
    ...
    model = AlphaZeroXiangqi(in_channels=TOTAL_IN_CHANNELS).to(device)
